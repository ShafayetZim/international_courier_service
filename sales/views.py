...
from sales.forms import SalesCreateForm, SalesChildFormset, CustomerCreateForm, ShipperCreateForm
from sales.models import SalesParent, SalesChild


from .models import Customers, Shipper
            ...
            for form in sales_form_child:
                ...
                if form.is_valid():
                    try:
                        ...
                        if (packing_qty is not None and packing_qty > 0) and (product_qty is not None and product_qty > 0):
...
def shipper_info(request):
    ...
    shipper = Shipper.objects.get(shipper_code=shipper_code)
    data = {
